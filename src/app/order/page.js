    ...
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6  mb-6 lg:mb-0">
        ...
        <div className="flex border-t border-gray-200 py-2">
          ...
          <span className="ml-auto text-white-900">Blue</span>
        </div>
        <div className="flex border-t border-gray-200 py-2">
          <span className="text-white">Size</span>
          <span className="ml-auto text-white-900">Medium</span>
        </div>
        <div className="flex border-t border-b mb-6 border-gray-200 py-2">
          <span className="text-white">Quantity</span>
          <span className="ml-auto text-white-900">4</span>
        </div>
        <div className="flex">
          ...
          <button className="flex mx-auto mt-2 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">
            Order
          </button>
      </div>
      <img
